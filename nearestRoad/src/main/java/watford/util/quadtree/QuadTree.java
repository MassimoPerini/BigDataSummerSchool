 ...
 *
 */
public class QuadTree implements ISpatialSet, Serializable {
	...
	public QuadTreeNode searchObj(Point obj)
	{
		return this.root.search(obj);
	}
	
	public LinkedList getNearestRoads (Car c)
	{
		 return this.root.getNearestRoad(c);
